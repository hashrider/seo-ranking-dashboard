              ...
              <tbody>
                <tr>
                  <td class="text-center">
                    <div class="photo">
                      <img src="{{ asset('black') }}/img/tania.jpg" alt="Table image">
                    </div>
                  </td>
                  <td>
                    Andrew Mike
                ...
                <tr>
                  <td class="text-center">
                    <div class="photo">
                      <img src="{{ asset('black') }}/img/robi.jpg" alt="Table image">
                    </div>
                  </td>
                  <td>
                    John Doe
                ...
                <tr>
                  <td class="text-center">
                    <div class="photo">
                      <img src="{{ asset('black') }}/img/lora.jpg" alt="Table image">
                    </div>
                  </td>
                  <td>
                    Alex Mike
                ...
                <tr>
                  <td class="text-center">
                    <div class="photo">
                      <img src="{{ asset('black') }}/img/jana.jpg" alt="Table image">
                    </div>
                  </td>
                  <td>
                    Mike Monday
                ...
                <tr>
                  <td class="text-center">
                    <div class="photo">
                      <img src="{{ asset('black') }}/img/emilyz.jpg" alt="Table image">
                    </div>
                  </td>
                  <td>
                    Manuel Rico
            ...
            <table class="table table-shopping">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="img-container">
                      <img src="{{ asset('black') }}/img/jacket.png" alt="...">
                    </div>
                  </td>
                  <td class="td-name">
                ...
                <tr>
                  <td>
                    <div class="img-container">
                      <img src="{{ asset('black') }}/img/t-shirt.png" alt="...">
                    </div>
                  </td>
                  <td class="td-name">
                ...
                <tr>
                  <td>
                    <div class="img-container">
                      <img src="{{ asset('black') }}/img/gucci.png" alt="...">
                    </div>
                  </td>
                  <td class="td-name">
